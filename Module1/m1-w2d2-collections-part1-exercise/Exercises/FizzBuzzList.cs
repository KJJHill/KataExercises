...
namespace Exercises
{
    public partial class Exercises
    {
        /*
         ...
         (as Strings). Except any multiple of 3
         should be replaced by the String "Fizz", 
         ...
         HINT: To convert an integer x to a string you can call x.ToString()
         in your code (e.g. if x = 1 then x.ToString() equals "1")
         */
        public List<string> FizzBuzzList(int[] integerArray)
        {
            ...
            for (int i = 0; i < integerArray.Length; i++)
            {
                ...
                {
                    result.Add(integerArray[i].ToString());
                }
            }
            return result;
        }
