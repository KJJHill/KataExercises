...
namespace TechElevator.Classes.Tests
{
    ...
    public class DogTests
    {
        ...
        public void Dog_MakeSound()
        {
            ...
            type.GetField("isSleeping").SetValue(dog, true);

            Assert.AreEqual("Zzzz...", mi.Invoke(dog, null), "The dog should say \"Zzzzz...\" when asleep.");
        }
        ...
        public void Dog_SleepTest()
        {
            ...
            Assert.AreEqual(true, type.GetField("isSleeping").GetValue(dog), "The dog should be sleeping after Sleep() is called.");
        ...
        public void Dog_WakeUpTest()
        {
            ...
            Assert.AreEqual(false, type.GetField("isSleeping").GetValue(dog), "The dog should be awake after WakeUp() is called.");
        }
    }
}